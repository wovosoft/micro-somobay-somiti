<template>
    ...
    <DataTable
        ...
        <Column field="type" header="Type" :sortable="true">
            <template #body="item">
                {{ item.data.type ? deposit_types.find(i => i.value === item.data.type).label : "" }}
            </template>
            <template #editor="item">
                <Dropdown
...
export default {
    ...
    methods: {
        ...
        rowEditSave(e) {
            axios
                .post("/admin/deposits/store", JSON.parse(JSON.stringify(e.data)))
                .then(res => {
                    this.$toast.add({
                        severity: 'success',
                        summary: 'Success',
        ...
        getItems(params = {}) {
            axios.post("/admin/deposits", {...params, ...this.datatable, ...this.query}).then(res => {
        ...
        exportItems() {
            ...
            form.setAttribute("action", "/admin/deposits/export");
        ...
        handleSubmit() {
            ...
            axios
                .post("/admin/deposits/store", JSON.parse(JSON.stringify(this.item)))
                .then(res => {
                    this.$toast.add({
                        severity: 'success',
                        summary: 'Success',
        ...
        trashItems() {
            if (this.selectedProducts.length && confirm("Are You Sure?")) {
                ...
                axios
                    .post("/admin/deposits/destroy", {id: ids})
                    .then(res => {
                        this.$toast.add({
                            severity: 'success',
                            summary: 'Success',
